...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="carapace-theme"
...
# date.sh {
	...
	export TMUX_POWERLINE_SEG_DATE_FORMAT="%Y-%m-%d %H:%M"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/cheilman/.mail/inbox/new"

	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/cheilman"

	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/cheilman/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/cheilman/.now_playing.log"
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="--colors --powerline-right --vertical-graph --mem-mode 2 --cpu-mode 0 --averages-count 3"
# }
